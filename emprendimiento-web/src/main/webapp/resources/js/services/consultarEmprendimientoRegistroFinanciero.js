    ...
    if (documento) {
        ...
        if (response.status === "0") {
            ...
            jQuery.each(lbeneficiarios, function (i, item) {
                ...
                if (item.estadoemprendimiento.idestadoemprendimiento === 5) {
...
function getEmprendimientoPorDoc(doc) {
    jQuery.ajax({
        type: "GET",
        url: context + "/getEmprendimientoPorDocEva2",
        contentType: "application/x-www-form-urlencoded; charset=UTF-8",
        dataType: "json",
        async: false,
...
function getEmprendimientoPorNombre(nombreEmprendimiento) {
    jQuery.ajax({
        type: "GET",
        url: context + "/getEmprendimientoPorNombreEva2",
        contentType: "application/x-www-form-urlencoded; charset=UTF-8",
        dataType: "json",
        async: false,
...
function  Registrar(idEmprendimiento) {
    $(".preloader").fadeIn();
    $.get(context + "/registrarInfoFinanciera", {idEmprendimiento: idEmprendimiento, idFuncionario: idfuncionario}, function (data) {
        $("#body_content").html(data);
        $("#idPage").html("Registro de Informacion Financiera");
        $(".preloader").fadeOut();
    });
}
