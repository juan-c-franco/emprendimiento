...
function modificarInstitucion() {
    ...
    $(".preloader").fadeIn();
    $.post(context + "/modificarInstitucionOferente", {nombreInstitucion: nombreInstitucion, nit: nit, correoElectronico: email,
        ...
        estadoAprobacion: estadoAprobacion, estado: estado, id: id}, function (data) {
        $(".preloader").fadeOut();
        ...
        if (data.status === '1') {
            ...
            swal({
                title: "Error Actualizando Institución",
                text: data.descripcion,
                type: "error",
                confirmButtonText: "Ok",
                showCancelButton: false
