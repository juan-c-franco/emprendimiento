...
function buscar() {
    ...
    $.get(context + "/getEmprendimientoPorNombreF",
...
function buscarxDoc() {
    ...
    $.get(context + "/getEmprendimientoPorDocF",
            {documento: documento,
                idfuncionario: idfuncionario, idcajacompensacion: idcajacompensacion},
            function (data) {
                $("#body_content").html(data);
...
function cargarFuncionarios() {
    ...
    $.post(context + "/infoFinancieraBasica", {idcajacompensacion: idcajacompensacion},
            function (data) {
                $("#body_content").html(data);
                $("#idPage").html("Registro Informacion Financiera Basica");
            });
...
function consulta() {
    ...
    $.post(context + "/infoFinancieraBasica", {idcajacompensacion: idcajacompensacion, idfuncionario: idfuncionario},
            function (data) {
                $("#body_content").html(data);
                $("#idPage").html("Registro Informacion Financiera Basica");
            });
