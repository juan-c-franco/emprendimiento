...
//                $('#theForm').on('click', '#programar', function (e) {
                        ...
                        if (!validationError) {
                            if (args === arg) {
                                ...
                                guardaProgramacion(moment(horaInicio).format('YYYY-MM-DD kk:mm'),
                                        moment(horaFin).format('YYYY-MM-DD kk:mm'), $("#descripSeguimiento").val(),
                                        $("#ubicacionSeguimiento").val());
                                calendar.unselect();
                            }
                        }
        ...
        success: function (result, status, xhr) {
            if (result.status == "1") {
                ...
                swal({
                    ...
                    $(".preloader").fadeIn();
                    loadView('Programar Sesion Puesta en Marcha y Seguimiento', context + '/programarPuestaMarchaSeguimiento');
                });
            } else {
                swal({
                    title: "Programar Sesión",
                    ...
                    success: function (result, status, xhr) {
                        if (result.status == "1") {
                            ...
                            swal({
                                ...
                                $(".preloader").fadeIn();
                                loadView('Programar Sesión', context + '/programarPuestaMarchaSeguimiento');
                            });
                        } else {
                                ...
                                success: function (result, status, xhr) {
                                    ...
                                    if (result.status == "1") {
                                        swal({
                                            ...
                                            $(".preloader").fadeIn();
                                            loadView('Programar Seguimiento', context + '/programarPuestaMarchaSeguimiento');
                                        });
                                    } else {
                                        swal({
                                            title: "Programar Sesión",
