...
function registrarDocente() {
    var idestadodocente = $("#idestadodocente").val();
    ...
    if (continuar) {
        $(".preloader").fadeIn();
        $.post(context + "/modificarDocente2", {iddocente: iddocente, idestadodocente: idestadodocente, primernombre: primernombre, segundonombre: segundonombre,
            ...
            if (data.status === '1') {
                ...
                swal({
                    title: "Error Actualizando Docente",
                    text: data.descripcion,
                    type: "error",
                    confirmButtonText: "Ok",
                    showCancelButton: false
