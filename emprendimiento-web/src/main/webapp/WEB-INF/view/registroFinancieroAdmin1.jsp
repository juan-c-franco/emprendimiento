<%-- 
    ...
    Created on : ene 18, 2019, 7:22:27 p.m.
...
<script src="${pageContext.request.contextPath}/resources/js/services/consultarEmprendimientoRegistroFinancieroBasico.js" type="text/javascript"></script>
<script>
