<%-- 
    ...
    Created on : nov 20, 2018, 11:20:13 p.m.
        ...
        <tbody>
            <c:forEach items="${emprendimientos}" var="tempEmprendimientos">
                <tr>
                    ...
                    <td ><a onclick="loadView('Valoración Grupal', '${pageContext.request.contextPath}/traerValoracionGrupal?idEmprendimiento=${tempEmprendimientos.idemprendimiento}&idFuncionario=${idfuncionario}')">Valorar</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
