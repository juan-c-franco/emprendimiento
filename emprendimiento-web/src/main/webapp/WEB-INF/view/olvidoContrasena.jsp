...
<html>
    ...
    <head>
        ...
        <title>Emprendimiento - Olvido su Contraseña</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <h3>EMPRENDIMIENTO<h3>             
                                ...
                                <div align="center">
                                    ...
                                    <form:form action="${pageContext.request.contextPath}/correoContrasena" method="GET">


                                        <div class="form-group mx-sm-3 mb-2" align="center">
                                            <label for="inputEmail" class="sr-only">Correo Electronico</label>
                                            <input name="correo" type="email" required="required" placeholder="Correo Electronico" style="width : 400px; heigth : 1px"/>
                                        </div>
                                        <button type="submit" class="btn btn-primary mb-2" align="center">Enviar Correo</button>

                                        <p class="font-weight-light">Ingrese su correo electrónico, recibirá un email con un link para restaurar su contraseña</p>
