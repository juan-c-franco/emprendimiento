<%-- 
    Document   : registrarAsistencia2V
    Created on : nov 13, 2018, 12:21:26 p.m.
...
<script src="${pageContext.request.contextPath}/resources/js/services/registrarAsistenciaV.js" type="text/javascript"></script>
<script>
