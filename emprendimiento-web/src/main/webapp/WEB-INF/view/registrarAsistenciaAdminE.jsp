<%-- 
    Document   : registrarAsistenciaAdminE
    Created on : nov 29, 2018, 11:20:23 a.m.
...
<div class="form-row">
    ...
    <script src="${pageContext.request.contextPath}/resources/js/services/registrarAsistenciaAdminE.js" type="text/javascript"></script>
