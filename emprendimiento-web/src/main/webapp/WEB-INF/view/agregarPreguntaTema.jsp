<%-- 
    Document   : agregarPreguntaTema
    Created on : 15/10/2018, 09:30:50 AM
...
<script src="${pageContext.request.contextPath}/resources/js/services/agregarPreguntaTema.js" type="text/javascript"></script>