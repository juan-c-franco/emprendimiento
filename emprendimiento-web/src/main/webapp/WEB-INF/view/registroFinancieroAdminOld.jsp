<%-- 
    Document   : registroFinancieroAdmin
    Created on : dic 5, 2018, 6:01:39 p.m.
...
<div class="form-row">
    ...
    <div class="row">
        <div class="form-group mx-sm-3 col-4">
            <label for="idEmprendimiento" class="sr-only">Id Emprendimiento</label>
            <input type="NumericTextBox" min="0" class="form-control " id="idEmprendimiento" placeholder="Id Emprendimiento" hidden="true" >
        </div>
        ...
        <tbody>
            <c:forEach items="${emprendimientos}" var="tempEmprendimientos">
                <tr>
                    ...
                    <td ><a onclick="loadView('Registro de Información Financiera Básica', '${pageContext.request.contextPath}/registrarInfoFinanciera?idEmprendimiento=${tempEmprendimientos.idemprendimiento}&idFuncionario=${idfuncionario}')">Registro</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
...
<script src="${pageContext.request.contextPath}/resources/js/services/consultarEmprendimientoRegistroFinanciero.js" type="text/javascript"></script>