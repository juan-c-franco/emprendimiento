<%-- 
    Document   : registrarAsistenciaS
    Created on : nov 29, 2018, 2:56:45 p.m.
        ...
        <c:if test ="${not empty sesiones}">
            ...
            <div class="list-group">
                <c:if test="${tempSesiones.estadosesion.idestadosesion!=4}">
                    <td> <a onclick="loadView('Registrar asistencia Seguimiento', '${pageContext.request.contextPath}/traerAsistentesS?idsesion=${tempSesiones.idsesion}&fecha=${tempSesiones.fechainicio}&idfuncionario=${tempSesiones.funcionario.idfuncionario}&idestadosesion=${tempSesiones.estadosesion.idestadosesion}')" class="list-group-item list-group-item-action">${tempSesiones.idsesion}</a></td>       
