<%-- 
    Document   : programarPuestaMarchaSeguimientoView
    Created on : 22/11/2018, 11:52:00 AM
    Author     : GrowData
--%>
...
<h3>Programar Sesión Puerta en Marcha y Seguimiento</h3>
<hr/>
<div id='calendar'></div>
            ...
            <div class="rangoTiempo modal-body">
                <div id="divDatosProgramacion">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div class="form-group row">
                                <label for="descripSeguimiento" class="control-label col-md-3">Descripción <span class="text-danger">*</span></label>
                                <div class="col-sm-9 controls">
                                    <input 
                                        type="text" 
                                        id="descripSeguimiento" 
                                        name="descripSeguimiento" 
                                        class="form-control" 
                                        required
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div class="form-group row">
                                <label for="ubicacionSeguimiento" class="control-label col-md-3">Ubicación <span class="text-danger">*</span></label>
                                <div class="col-sm-9 controls">
                                    <input 
                                        type="text" 
                                        class="form-control" 
                                        id="ubicacionSeguimiento" 
                                        name="ubicacionSeguimiento" 
                                        required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 controls">
                                    <input type="text" class="form-control editHora" 
                                           id="horaInicio" name="horaInicio" autocomplete="off" 
...
<div class="modal fade" id="modalOpciones" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Editar sesión de Seguimiento</h5>
                <button class="close" type="button" data-dismiss="modal"
                        aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
...
<script src="${pageContext.request.contextPath}/resources/js/services/programarPuestaMarchaSeguimiento.js" type="text/javascript"></script>
<script>
