<%-- 
    Document   : registrarAsistencia2S
    Created on : nov 29, 2018, 3:09:23 p.m.
            ...
            <tbody >
                ...
                <c:forEach var="tempListaAsistencia" items="${listaAsistencia}">
                    <tr>
                        ...
                        <c:set var="count" value="${tempListaAsistencia.registroasistencia == '1' ? '9768' : ''}" scope="page"/>
                    </tr>
                </c:forEach>
                </div>
...
<script src="${pageContext.request.contextPath}/resources/js/services/registrarAsistenciaS.js" type="text/javascript"></script>
<script>
