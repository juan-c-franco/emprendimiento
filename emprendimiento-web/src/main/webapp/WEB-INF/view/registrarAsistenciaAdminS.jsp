<%-- 
    Document   : registrarAsistenciaAdminS
    Created on : nov 29, 2018, 2:54:20 p.m.
...
<div class="form-row">
    ...
    <script src="${pageContext.request.contextPath}/resources/js/services/registrarAsistenciaAdminS.js" type="text/javascript"></script>
