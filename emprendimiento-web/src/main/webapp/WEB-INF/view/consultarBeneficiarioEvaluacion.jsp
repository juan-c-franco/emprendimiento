...
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive m-t-20">
            <table id="tableData" class="table table-bordered table-striped dataTablas">
                <thead>
                    <tr>
                        <th>Documento</th>
...
<script src="${pageContext.request.contextPath}/resources/js/services/consultaBeneficiarioEvaluacion.js" type="text/javascript"></script>
<script>
